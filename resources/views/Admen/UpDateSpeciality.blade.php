        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(/metronic8/demo22/assets/media/illustrations/sketchy-1/14.png">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form action="{{ route('UpDate',$speciality->id ) }}" method="POST" class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_sign_up_form">
                        @csrf
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="text"  value="{{$speciality->Speciality_img}}" placeholder="" name="Speciality_img" autocomplete="off">
                        <!--end::Input group-->
                        <!--begin::Input group-->
