...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative app-blank">
		<!--begin::Root-->
						...
						<div class="container">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="flex-equal text-end ms-1">
									<a href="../../demo22/dist/authentication/flows/basic/sign-in.html" class="btn btn-success">Sign In</a>
								</div>
								<!--end::Toolbar-->
							</div>
							<!--end::Wrapper-->
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						...
						<div class="fs-2 fw-bold text-muted text-center">
							<a href="../../demo22/dist/account/security.html" class="link-primary fs-4 fw-bolder">Marcus Levy,</a>
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
								...
								<div class="rounded landing-dark-border p-9">
									...
									<a href="../../demo22/dist/pages/user-profile/overview.html" class="text-white opacity-50 text-hover-primary">Click to Get a Quote</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
							</div>
							...
							<div class="col-lg-6 ps-lg-16">
								...
								<div class="d-flex justify-content-center">
									...
									<div class="d-flex fw-bold flex-column me-20">
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="../../demo22/dist/documentation/getting-started.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Documentaions</a>
										<!--end::Link-->
										<!--begin::Link-->
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="../../demo22/dist/documentation/getting-started/changelog.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Changelog</a>
										<!--end::Link-->
										<!--begin::Link-->
